...
import { useOpenClawMessages } from './useOpenClawMessages.js'
...
function App() {
  ...
  const { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, workspaceFolders } = useOpenClawMessages(getOfficeState, '/api/agents')
